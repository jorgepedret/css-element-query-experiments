        ...
        function attachResizeEvent(element, resized) {
            ...
            if (element.onresize) {
                ...
                if (element.attachEvent) {
                    element.attachEvent('onresize', element.resizedAttached.doit);
                } else if (element.addEventListener) {
                    element.addEventListener('resize', element.resizedAttached.doit);
                }
            } else {
                var myResized = function(){
                    if (setupSensor()) {
                        element.resizedAttached.doit();
                    }
                }
        ...
        function setupElement(element, options) {
            if (element.elementQueriesSetupInformation) {
                ...
                attachResizeEvent(element, function(){
                    element.elementQueriesSetupInformation.doit();
                });
            }
            element.elementQueriesSetupInformation.doit();
        }
